	...
	// need to construct a new ArrayList otherwise remove operation will not be supported
      ...
      {"How are you?", "How you doing?","Joe", "Mike"}));*/
	   ...
	   String[] nevek = {"Tibor ", "Gábor ", "Péter ","Ádám","Mátyás","Gabriella","Gáspár","Éva","Ákos","Ábel","Ödön","Örs"};
		...
		nyeroszamok.add(3);
		nyeroszamok.add(5);
		System.out.println("Nyerőszámok (TreeSet): "+nyeroszamok);
		ArrayList<Integer> szamoktomb = new ArrayList<Integer>(nyeroszamok);
		System.out.println("Nyerőszámok: (Tömb): "+Arrays.asList(szamoktomb));
		System.out.println();
		...
		System.out.println("Nevek tömbből létrehozott lista + új nevek beszúrva az elejére: "+nevlista);
		System.out.println("Ezt is megszűrjűk, csak azokat hagyjuk meg, amiben szerepel az \"or\" szótag: "+szuro(nevlista,"or"));
		...
		filmek.get(1).add("Vissza a jövőbe I.");
		filmek.get(2).add("Vissza a jövőbe II.");
		filmek.get(3).add("Vissza a jövőbe III.");
