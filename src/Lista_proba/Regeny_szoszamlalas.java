...
public class Regeny_szoszamlalas 
{
   ...
   public static void main(String[] args) 
   {
      ...
      while (in.hasNext()) {
       ...
       System.out.println("Az első "+listaHossz+" leggyakoribb szó előfordulás szerint rendezve, mellette az előfordulások száma. ");
       System.out.println("A(z) " + minHossz + " betűnél rövidebb szavakat nem vettük figyelembe.");
       System.out.println();
       ...
       System.out.println();
       System.out.println("Az első "+listaHossz+" leggyakoribb szó hossz szerint rendezve, mellette az előfordulások száma.");
       System.out.println("A(z) " + minHossz + " betűnél rövidebb szavakat nem vettük figyelembe.");
       System.out.println();
       elso10.forEach((Szodb e) -> {
          System.out.print(e);
       });
       System.out.printf("%,6d féle különböző szó.",statisztika.size());
     }
     catch (IOException e) {
